  ...
  return (
    <div id="page">
      <div className="min-h-screen p-8">
        <Modal onClose={() => setModalContent("")}>{modalContent}</Modal>
      ...
      <h1 className="text-4xl font-bold text-center mb-8">Sui zkLogin demo</h1>
      ...
      <div className="max-w-md mx-auto mb-8">
        ...
        <div className="flex flex-col gap-3">
          {openIdProviders.map((provider) => (
            <button
              className={`px-4 py-2 rounded-lg font-medium text-primary-foreground ${
                provider === "Google" ? "bg-primary hover:bg-primary/90" :
        ...
        <div className="max-w-md mx-auto mb-8">
          ...
          <div className="space-y-6">
            {accounts.current.map((acct) => {
              ...
              return (
                <div key={acct.userAddr} className="bg-card p-4 rounded-lg shadow">
                  <div className="mb-2">
                    <span className={`inline-block px-2 py-1 text-sm font-medium rounded ${
                      acct.provider === "Google" ? "bg-primary/10 text-primary" :
